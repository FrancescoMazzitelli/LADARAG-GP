...
// ── Service constants ──────────────────────────────────────────────────────
def SERVICE_NAME           = "smart-city-intelligence-api-mock"
def SERVICE_ID             = "smart-city-intelligence-mock"
...
def API                    = "Smart+City+Intelligence+API"
def OPENAPI_FILE           = "Smart%20City%20Intelligence%20API-1.0.yaml"
def API_VERSION            = "1.0"
...
if (responseMap.status == "success") {
    return "ok"   // punta all'esempio 'ok' nel YAML
} else {
